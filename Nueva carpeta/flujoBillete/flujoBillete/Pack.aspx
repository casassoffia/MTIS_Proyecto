<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pack.aspx.cs" Inherits="flujoBillete.Pack" Async="true"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
     ...
     <div class="jumbotron">
        <h1>Reserva nuestro Pack:Coche,Billete y Hotel</h1>
        <p class="lead">Para ello debes introducir los siguientes datos:</p>
        <p class="lead">DNI:</p>
        <p class="lead">
        ...
        <p class="lead">
         ...
         <p class="lead">
             &nbsp;</p>
         <p>
            <asp:Button ID="reservarPack" runat="server" Text="Reservar" OnClick="crear" Width="180px" />
        </p>
