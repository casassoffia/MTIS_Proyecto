 ...
 */
            ...
            /**
            *  ValidarClienteResponse bean class
            */
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://www.mtis.org/Validar/");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ValidarClienteResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ValidarClienteResponse",
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://www.mtis.org/Validar/")){
                return "ns1";
            }
    ...
    public static class Factory{
        ...
        */
        public static ValidarClienteResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidarClienteResponse object =
                new ValidarClienteResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ValidarClienteResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidarClienteResponse)org.mtis.www.validar.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
