 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":asignarAsiento",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "asignarAsiento",
    ...
    public static class Factory{
        ...
        */
        public static AsignarAsiento parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AsignarAsiento object =
                new AsignarAsiento();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"asignarAsiento".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AsignarAsiento)org.mtis.www.vuelo.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
