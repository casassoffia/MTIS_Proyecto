...
/**
 * ComprobarDisponibilidadResponse.java
 *
 ...
 */
            ...
            /**
            *  ComprobarDisponibilidadResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ComprobarDisponibilidadResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.mtis.org/Vuelo/",
                "comprobarDisponibilidadResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":comprobarDisponibilidadResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "comprobarDisponibilidadResponse",
    ...
    public static class Factory{
        ...
        */
        public static ComprobarDisponibilidadResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ComprobarDisponibilidadResponse object =
                new ComprobarDisponibilidadResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"comprobarDisponibilidadResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ComprobarDisponibilidadResponse)org.mtis.www.vuelo.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
